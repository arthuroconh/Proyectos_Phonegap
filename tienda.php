    ...
    <section class="principal">
        ...
        <section class="contenedorr">
            ...
            <?PHP
                ...
                ?>
                    <article class="contieneproducto">
                        <article class="producto2">
                           <a href="producto.php?pro_id=<?php echo $row['pro_id']?>"><img src="productos/<?PHP echo $row['pro_img']?>"></a>
                ...
                echo"<center><div class='contienepaginador'><div class='posicionador'><p id='posicionarpaginacion'>Pagina:   ".$_pagi_navegacion."</p></div></div></center>";
            ?>
            </section>
        </section>
    </section>   
