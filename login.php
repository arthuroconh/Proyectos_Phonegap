...
setTimeout ('redireccionar()', 100);
        	...
        	if ((!isset($_SESSION['usuario']) && isset($_GET['carro']) && !isset($_GET['error']))) {
        		echo "
        		<section class='contenedor'>
	            	<center><h1>Iniciar sesi&oacute;n</h1>
	                    <article class='contienelog'>                        
	                        <div class='producto'>
	                        <form action='logeo-comprar.php' method='POST'>
									<span>Usuario<br><input type='text' placeholder='Usuario' name='usu_usu'> </span>
									<span>Contrase&ntilde;a <input type='password' placeholder='Contrase&ntilde;a' name='usu_cla'></span>
        		...
        		";
        	}else if(isset($_GET['error']) && !isset($_SESSION['usuario']) && !isset($_GET['carro'])){
?>

        <section class="contenedor">
            	<center><h1 style='color:#e74c3c;'>Usuario o contrase&ntilde;a incorrectos</h1>
                    <article class="contienelog">
                        
                        <div class="producto">
                        <form action="logeo.php" method="POST">
								<span><br>Usuario <br><br><input type="text" placeholder="Usuario" name="usu_usu"></span>
								<span><br><br>Contrase&ntilde;a <br><br><input type="password" placeholder="Contrase&ntilde;a" name="usu_cla"></span>
								<input type="submit" value="Ingresar">
						</form> 	
                        </div> 
       	...
       	<?PHP
       		}elseif (!isset($_SESSION['usuario']) && !isset($_GET['error']) && !isset($_GET['carro'])) {
            ?>
            <section class="contenedor">
                <center><h1>Iniciar sesi&oacute;n</h1>
                    <article class="contienelog">
            ...
            elseif (isset($_GET['carro']) && isset($_GET['error'])) {
            ?>
            <section class="contenedor">
                <center><h1 style='color:#e74c3c;'>Usuario o contrase&ntilde;a incorrectos</h1>
                    <article class="contienelog">
