...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        // declara variables para la redireccion
        var pagina = 'login.php';
        var milisegundos = 8000;
        // redirecciona a la pagina indicada
        function redireccion() {
            document.location.href=pagina;
        }
        // redirecciona a la pagina indicada al agotar el timeout
        window.setTimeout("redireccion()",milisegundos);
   		</script>
    </head>
    <body>
    <section class="principal">
        ...
        <section class="contenedor">
            <section class="stock">
                    <center><article class="contienelog">
                        
                        <div class="mensaje_registro">
	                        <h1>Felicidades, ahora formas parte de nuestra falimia.</h1><br>
	                        <h2>Ingresa haciendo <a href="login.php"> click aqu&iacute;</a> o espera a ser redirigido</h2><br>
                        </div> 
