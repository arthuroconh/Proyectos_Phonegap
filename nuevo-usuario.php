...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<script type="text/javascript">
			function enviar(){
				...
				var formu = document.getElementById("formu").value;
				var nombre = document.getElementById("nombre").value;
			 	var usuario = document.getElementById("usuario").value;
			 	var contrasena1 = document.getElementById("contrasena1").value;
			 	var contrasena2 = document.getElementById("contrasena2").value;
			 	var nombre = document.getElementById("txt_email").value;
				if (nombre=="" || usuario==""  || contrasena1==""  || contrasena2=="" || txt_email==""){
					alert("Todos los campos son Obligatorios ");
					return false;
				} else{
					var dirEmail = document.getElementById('txt_email');
					var expRegEmail = /^([\w.-]){2,64}@([\w.-]){2,64}(\.[\w-]{2,64})+$/;
					if(!(expRegEmail.test(dirEmail.value))) {
						dirEmail.style.color="#F00";
						dirEmail.focus();
						return false;
						['']
				} else {
		...
		<script type="text/javascript">
			function validarContra() {
				var contra1 = document.getElementById('contrasena1').value;
				var contra2 = document.getElementById('contrasena2').value;
				var contraV = document.getElementById('contrasena2');

				if(contra1!=contra2){
					contraV.style.color="#F00";
					contraV.focus();
					alert("Contraseñas no coniciden");
				 	return false;
				}else{
					contraV.style.color="#fafafa";
				return false;
				}
				return false;
			}
    ...
    <section class="principal">
        ...
        <section class="contenedor">
            <section class="stock">
                    <center>
                    	<h1>Datos de nuevo usuario</h1><br>

                    <article class="contieneusu">
                        
                        <div class="producto">
                        <form action="insertar_usuario.php" method="POST" id="formu" onsubmit="return enviar();validarEmail()">
                        		<br><span>Nombre de la empresa o persona</span><input type="text" name="usu_nom" id="nombre" required="required">
								<span>Usuario</span><input type="text" name="usu_usu" id="usuario" required="required">
								<span>Contrase&ntilde;a</span><input type="password" name="usu_cla" id="contrasena1" required="required">
								<span>Repetir Contrase&ntilde;a</span><input type="password" onchange="validarContra()" name="" id="contrasena2" required="required">
								<span>Correo</span><input type="text" name="usu_cor" onclick="validarContra()" id="txt_email" required="required" style="color:#fafafa;">
								<input type="submit" value="Registrar" onclick="validarEmail();validarContra()">
						</form> 	
                        </div> 
