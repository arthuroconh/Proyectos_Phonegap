<?PHP
	...
	if(!isset($_SESSION['usuario'])){
			header('Location: ../login.php?carro=carro');
		}
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <section class="principal">
        ...
        <section class="contenedor">
            <article class="contienefacturacion"> <h2>DATOS DE FACTURACION</h2> 
                <form name="formulario" method="POST" action="compras.php">
                    <span>A nombre de:</span><input type="text" name="nombre" required="required"><br>
                    <span>RIF:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" name="rif" required="required"> <br>              
                    <span>Direcci&oacute;n:&nbsp;&nbsp;</span><input type="text" name="direccion" required="required"><br>
                    <span>Telefono:&nbsp;&nbsp;&nbsp;</span><input type="number" name="telefono" required="required" style="backgroud:#fff;"><br>
                    <span>Correo:&nbsp;&nbsp;&nbsp;</span><input type="email" name="correo" required="required" style="backgroud:#fff;"><br>
                    <center><br><br><input type="submit" name="envarfactura" value="Procesar Orden" required="required"></center>
                </form>
            </article>
        </section>
        <?PHP
