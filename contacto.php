...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <section class="principal">
        ...
        <section class="contenedor">
            	<center><h1>Complete todos los campos</h1>
                    <article class="contienefor">
                        <div class="fcont">
                        <form action="formulariodecontacto.php" method="POST">
								<span><br>Nombre<br><br><input type="text" placeholder="Nombre" name="nombre" required="required"></span>
                                <span><br>Telefono<br><br><input type="number" placeholder="Telefono" name="telefono" required="required"></span>
                                <span><br>Correo<br><br><input type="email" placeholder="Correo" name="correo" required="required"></span>
                                <span><br>Mensaje<br><br><textarea name="mensaje" style="color:#fafafa; height:90px;" required="required"></textarea></span>
