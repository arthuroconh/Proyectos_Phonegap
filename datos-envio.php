...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <section class="principal">
        ...
        DATOS DE FACTURACION
	        ...
	        A nombre de:<input type="text" name="nombre" required="required"><br>
	        RIF:<input type="text" name="rif" required="required"><br>
	        Direcci&oacute;n:<input type="text" name="direccion" required="required"><br>
