    ...
    <section class="principal">
        ...
        <section class="contenedor6">
            ...
            <?PHP
                ...
                $numeroventa=0;
                $consulta=mysql_query("SELECT * FROM `t_car` ORDER BY `ord_id` Desc");
            ...
            ?> 
                ...
                <article class="norden">
                    <b>Orden</b> <?PHP echo $row['ord_id'];
                    $qqw=mysql_query("SELECT * FROM `t_ord` WHERE `t_ord`.`ord_id`=$row[ord_id]");
                    ...
                    echo "<br><article class='totalizer'><a href='detalles.php?orden=$row[ord_id]'>Detalles de Orden<a></article>";
                    ?><br><br>
                <article class="prod">
                    <?PHP
            }
                    ...
                    echo "<img src='productos/".$g['pro_img']."' width='80px'>
                            <a href='producto.php?pro_id=".$g['pro_id']."'><article class='produ'>".$g['pro_pro']."</article></a><br><br>
                    ";
            }
            ?>
        </section>
