    ...
    <section class="principal">
        ...
        <section class="contienemensaje">
            ...
            <article class="redes">
                     ...
                     <a href="eliminar-producto.php?id=<?PHP echo $id?>"><center style="margin-top:250px; position:absolute; margin-left:80%; background-color:#e74c3c; color:#fafafa; border-radius:8px; height:40px; padding:5px; font-size:20px;">Eliminar</center></a>
        <div style="clear:both;"></div>
        <section class="contenedor">
            ...
            <?PHP
                ...
                ?>
                    <article class="contieneproductok" id="posicionadorf">
                        <article class="producto">
                            <form action="actualizar.php" method="POST" name="formulario" enctype="multipart/form-data"> 
                                <center><img src="productos/<?PHP echo $row['pro_img']?>" width="200px"></center><br>
                                Nombre:<input type="text" id="nombre" name="pro_nom" value="<?PHP echo $row['pro_pro']?>"><br><br>
                                Precio:<input type="text" id="precio" name="pro_pre" value="<?PHP echo $precio_arreglado;?>"><br><br>
                                Descripcion:<textarea name="pro_des"><?PHP echo $row['pro_des']?></textarea><br><br>
                                Imagen:<input type="file" name="pro_img"><br>
